 ...
 * bonus.
 */
public abstract class ThreeExp extends BaseExpression {
    /**
     * first exp.
     */
     ...
     */
    public ThreeExp(Expression one, Expression two, Expression three) {
        this.num1 = one;
        this.num2 = two;
        this.num3 = three;
     ...
     */
    protected abstract Expression type(Expression one, Expression two, Expression three);
    ...
    public double evaluate(Map<String, Double> assignment) throws Exception {
        ...
        for (Map.Entry<String, Double> pair : assignment.entrySet()) {
            ...
            /*for (int i = 0; i < this.type(this.num1, this.num2, this.num3).getVariables().size(); i++) {
                if (!pair.getKey().equals(this.type(this.num1, this.num2, this.num3).getVariables().get(i))) {
                    count++;
                }
            }

        }
        if (count == this.type(this.num1, this.num2, this.num3).getVariables().size()) {
            throw new Exception("val not in assignment");
        }*/
        }

        return this.type(this.num1, this.num2, this.num3).evaluate();
    ...
    public Expression assign(String var, Expression expression) {
        ...
        return this.type(first, second, third);
    }
